---
foerderer_kooperationspartner:
  kurzbeschreibung: >-
    der verschiedenen nationalen und internationalen Projekte der Deutschen
  ...
  foerderer:
    ...
    - name: Behörde für Schule und Berufsbildung der Freien und Hansestadt Hamburg
      email_web: >-
        ...
        behoerde_fuer_schule_jugend_und_berufsbildung/
  kooperationspartner:
    - name: Arbeitsgemeinschaft Natur- und Umweltbildung e. V.
      email_web: netzwerk@anu.de
mitgliedschaft:
  kurzbeschreibung: >-
    Rahmenbedingungen und Informationen zur Mitgliedschaft bei der Deutschen
    Gesellschaft für Umwelterziehung.
  content: >
    # Mitgliedschaft
    ...
    Wir würden uns freuen, wenn Sie aktives oder förderndes Mitglied der
    Deutschen Gesellschaft für Umwelterziehung e. V. werden.


    Die DGU bietet ihren Mitgliedern folgenden Service:


    * Kostenlose Zusendung der DGU- Nachrichten und eigener aktueller
    Publikationen zu Themen der Umweltbildung

    * Teilnahmemöglichkeiten an Tagungen, Konferenzen und anderen Foren,
    vorrangig oder ausschließlich, mit Ermäßigung

    * Allgemeine Informationen zur Umweltbildung in der Bundesrepublik
    ...
    Mitglieder können natürliche und juristische Personen werden, die die Ziele
    der Gesellschaft unterstützen und zu deren Verwirklichung beitragen wollen.
    Über die Aufnahme entscheidet der Vorstand auf schriftlichen Antrag. Jedes
    Mitglied hat einen Mitgliedsbeitrag zu entrichten. Die Mitgliedschaft ist
    kündbar.
    ...
    Auszubildende, Schüler und Studenten: 13 Euro


    ### Mitgliedschaft beantragen


    Um die Mitgliedschaft beantragen zu können, stehen Ihnen folgende
    ...
    1. Speichern Sie den Aufnahmeantrag auf Ihrem Computer\
       [Download PDF](/uploads/MitgAntrag.PDF "MitgAntrag.PDF")
    2. Unterschreiben Sie den Antrag

    3. Schicken Sie den Antrag per Email an sekretariat@umwelterziehung.de oder
    per Post an:\
       **DGU-Büro Erfurt**\
       Goethestraße 64\
       99096 Erfurt\
    ...
    Die Satzung kann unter oben genannten Adresse angefordert werden.
vorstand:
  personen:
    ...
    - funktion: Stellvertretender Vorsitzender
      name: Harry Funk
      adresse: >-
        Senatsverwaltung für Bildung, Jugend und Familie, Bernhard-Weiß-Straße
        6, 10178 Berlin
      telefon: +49 30 902276648
      email: harry.funk@senbjf.berlin.de
---
...
16.3.1976 in der jeweils gültigen Fassung. Der Verein ist selbstlos
